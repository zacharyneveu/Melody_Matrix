...
class PianoRollAudioDatasetSimple(Dataset):
...
class MAESTRO_SIMPLE(PianoRollAudioDatasetSimple):

    def __init__(self, path='/home/zach/Data/maestro/maestro-v2.0.0', groups=None, sequence_length=None, seed=42, device=DEFAULT_DEVICE):
    ...
    def files(self, group):
        ...
        result = []
        for audio_path, midi_path in tqdm(files, desc='Parsing midi files'):
...
class MAPS_SIMPLE(PianoRollAudioDatasetSimple):
